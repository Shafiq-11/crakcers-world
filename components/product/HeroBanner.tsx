  ...
  return (
    <section className="bg-white border-b border-gray-100 pb-2 pt-2 sm:pt-4 sm:pb-4">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        {/* Quick-Commerce Search Bar with Mobile Keyboard Dismiss */}
        <form
          onSubmit={handleSearchSubmit}
          action="#"
          className="relative w-full max-w-2xl mx-auto mb-2 sm:mb-3"
        >
          <input
            ref={inputRef}
            type="search"
          ...
          />
          <svg
            className="absolute left-3 top-2.5 sm:top-3.5 w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 pointer-events-none"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-2.5 top-2 sm:top-2.5 text-xs text-gray-400 hover:text-gray-600 p-1 cursor-pointer"
            >
              ✕
            </button>
          )}
